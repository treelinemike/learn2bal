...
theta_end = 80*pi/180;
Icombined = sysParams.Ic + sysParams.Ip + (sys.Params.mc + sysParams.mp)*sysParams.r_wheel^2 + sysParams.mp*(sysParams.l_cm^2 + 2*sysParams.r_wheel*sysParams.l_cm*sin(sysParams.theta0));
